...
--
-- テーブルの構造 `calendar_plan`
--

CREATE TABLE `calendar_plan` (
  `plan_id` int(11) NOT NULL COMMENT 'プランID',
  `user_id` int(11) NOT NULL COMMENT 'ユーザーID',
  `plan_title` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT 'タイトル',
  `plan_date` date NOT NULL COMMENT '日付',
  `plan_description` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '詳細',
  `plan_notice` tinyint(1) NOT NULL COMMENT '通知設定'
...
--
-- テーブルの構造 `user_login_pc`
--

CREATE TABLE `user_login_pc` (
  `pc_id` int(11) NOT NULL COMMENT 'PC ID',
  `pc_uuid` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT 'PC UUID',
  `user_id` int(11) NOT NULL COMMENT 'ユーザーID',
  `env_ua` varchar(300) COLLATE utf8mb4_bin NOT NULL COMMENT 'ユーザーエージェント',
  `env_ip` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT 'IPアドレス',
  `validity_flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '有効フラグ',
  `timestamp` datetime NOT NULL COMMENT '登録日付'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
--
-- テーブルのインデックス `calendar_plan`
--
ALTER TABLE `calendar_plan`
  ADD PRIMARY KEY (`plan_id`),
  ADD KEY `calendar_plan_user_user_id_fk` (`user_id`);
...
--
-- テーブルのインデックス `user_login_pc`
--
ALTER TABLE `user_login_pc`
  ADD PRIMARY KEY (`pc_id`),
  ADD UNIQUE KEY `user_login_pc_pc_uuid_uindex` (`pc_uuid`),
  ADD KEY `user_login_pc_user_user_id_fk` (`user_id`);
...
--
-- テーブルのAUTO_INCREMENT `calendar_plan`
--
ALTER TABLE `calendar_plan`
  MODIFY `plan_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'プランID';
...
--
-- テーブルのAUTO_INCREMENT `user_login_pc`
--
ALTER TABLE `user_login_pc`
  MODIFY `pc_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PC ID';
...
--
-- テーブルの制約 `calendar_plan`
--
ALTER TABLE `calendar_plan`
  ADD CONSTRAINT `calendar_plan_user_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
...
--
-- テーブルの制約 `user_login_pc`
--
ALTER TABLE `user_login_pc`
  ADD CONSTRAINT `user_login_pc_user_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
